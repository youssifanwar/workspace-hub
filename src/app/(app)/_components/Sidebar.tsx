    ...
    <aside className="w-64 shrink-0 bg-[#0b1020] text-white flex flex-col sticky top-0 h-screen">
      ...
      <div className="px-5 pt-6 pb-4 border-b border-white/10">
        <div className="flex items-center gap-3">
          <div
            className="w-10 h-10 rounded-xl bg-gradient-to-br from-indigo-500 to-cyan-400 grid place-items-center text-lg font-bold shadow-lg"
            aria-hidden="true"
          >
            🏢
          </div>
      ...
      {/* NAVIGATION */}
      <nav
        className="flex-1 p-3 space-y-1 overflow-y-auto scroll-fade"
